...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const vrfCoordinator = process.env.VRF_COORDINATOR_ADDRESS_ARBITRUM_ONE;
  const vrfKeyHash = process.env.VRF_KEY_HASH_ARBITRUM_ONE;
  const vrfSubscriptionId = process.env.VRF_SUBSCRIPTION_ID_ARBITRUM_ONE;
...
export default func;
func.id = "deploy_raffle_system_arb_one";
func.tags = ["NewRaffleArbitrumMainnet", "SatoshieTickets"];
